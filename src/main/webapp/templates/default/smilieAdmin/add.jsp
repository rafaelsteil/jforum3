...
<table class="forumline" cellspacing="1" cellpadding="3" width="100%" border="0">
	<tr>
		<th class="thhead" valign="center" colspan="2" height="25"><jforum:i18n key='Smilies.Form.Title'/></th>
	</tr>
        
	<tr>
		<td class="row1 gen" width="38%"><jforum:i18n key='Smilies.Form.Code'/></td>
		<td class="row2"><input class="post" style="width: 200px" maxlength="25" size="25" name="smilie.code" value="${smilie.code}"/></td>
	</tr>
	
	<tr>
		<td class="row1 gen"><jforum:i18n key='Smilies.Form.Url'/></td>
		<td class="row2">
	...
	<tr align="center">
		<td class="catbottom" colspan="2" height="28">
			<input class="mainoption" type="submit" value="<jforum:i18n key='Smilies.Form.ClickToUpdate'/>"/>
		</td>
	</tr>
