...
<form action="<jforum:url address='/jforum'/>?module=${saveModule}&action=${saveAction}" method="post" enctype="multipart/form-data" name="post" id="post" onSubmit="return validatePostForm(this)">
