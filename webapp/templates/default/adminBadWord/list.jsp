...
<form name="form" action="<jforum:url address='/jforum'/>?module=adminBadWord&action=delete" method="post">
...
<table class="forumline" cellspacing="1" cellpadding="3" width="100%" border="0">
	...
	<c:forEach items="${words}" var="word">
		<tr>
			...
			<td class="row1 gen" align="center"><a href="<jforum:url address='/jforum'/>?module=adminBadWord&action=edit&id=${word.id}"><jforum:i18n key="Edit"/></a></td>
	...
	<tr align="center">
		<td class="catbottom" colspan="5" height="28">
			<input class="mainoption" type="button" value="<jforum:i18n key="Rank.List.ClickToNew"/>" name="button" onclick="document.location = '<jforum:url address='/jforum'/>?module=adminBadWord&action=add';" />
			&nbsp;&nbsp;
