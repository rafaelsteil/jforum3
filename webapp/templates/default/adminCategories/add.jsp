...
<form action="<jforum:url address='/jforum'/>?module=adminCategories&action=${saveAction}" method="post" name="form" id="form" accept-charset="${encoding}" onSubmit="return checkGroups()">
