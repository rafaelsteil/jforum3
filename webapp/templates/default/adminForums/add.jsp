...
<form action="<jforum:url address='/jforum'/>?module=adminForums&action=${saveAction}" method="post" name="form" id="form" accept-charset="${encoding}" onSubmit="return checkInput();">
