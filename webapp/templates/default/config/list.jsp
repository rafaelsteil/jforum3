...
<tr>
	...
	<td class="row1" width="38%"><span class="gen"><input type="text" size="50" name="p_forum.link" value="${config.getValue$1["forum.link"]}" /></span></td>
</tr>

<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.SiteURL"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="50" name="p_homepage.link" value="${config.getValue$1["homepage.link"]}" /></span></td>
</tr>

<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.forumName"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="50" name="p_forum.name" value="${config.getValue$1["forum.name"]}" /></span></td>
</tr>

<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.ForumPageTitle"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" size="50" name="p_forum.page.title" value="${config.getValue$1["forum.page.title"]}" /></span></td>
</tr>

<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.MetaTag.description"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" size="50" name="p_forum.page.metatag.description" value="${config.getValue$1["forum.page.metatag.description"]}" /></span></td>
</tr>

<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.MetaTag.keywords"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="50" name="p_forum.page.metatag.keywords" value="${config.getValue$1["forum.page.metatag.keywords"]}" /></span></td>
</tr>

<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.encoding"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" size="10" name="p_encoding" value="${config.getValue$1["encoding"]}" /></span></td>
</tr>
...
<tr>
	...
	<td class="row1" width="38%"><span class="gen"><input type="text" size="10" name="p_topicsPerPage" value="${config.getValue$1["topicsPerPage"]}" /></span></td>
</tr>

<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.PostsPerPage"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="10" name="p_postsPerPage" value="${config.getValue$1["postsPerPage"]}" /></span></td>
</tr>

<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.UsersPerPage"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" size="10" name="p_usersPerPage" value="${config.getValue$1["usersPerPage"]}" /></span></td>
</tr>

<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.postsNewDelay"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" size="10" name="p_posts.new.delay" value="${config.getValue$1["posts.new.delay"]}" /></span></td>
</tr>
...
<tr>
	...
	<td class="row2" width="38%"><span class="gen"><input type="text" size="10" name="p_avatarMaxKbSize" value="${config.getValue$1["avatarMaxKbSize"]}" /></span></td>
</tr>
<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.avatarMaxWidth"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" size="10"name="p_avatar.maxWidth" value="${config.getValue$1["avatar.maxWidth"]}" onchange="changeValue('thumbW', this.value)"/></span></td>
</tr>
<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.avatarMaxHeight"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="10"name="p_avatar.maxHeight" value="${config.getValue$1["avatar.maxHeight"]}" onchange="changeValue('thumbH', this.value)"/></span></td>
</tr>
<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.avatarPreview"/></span></td>
	<td class="row2" width="38%">
		<input type="hidden" name="thumbH" value="${config.getValue$1["avatar.maxHeight"]}">	
		<input type="hidden" name="thumbW" value="${config.getValue$1["avatar.maxWidth"]}">
...
<tr>
	...
	<td class="row1" width="38%"><span class="gen"><input type="text" size="10" name="p_mail.charset" value="${config.getValue$1["mail.charset"]}" /></span></td>
</tr>
<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.Sender"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="50" name="p_mail.sender" id="sender" value="${config.getValue$1["mail.sender"]}" /></span></td>
</tr>
<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.MailHost"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="50" name="p_mail.smtp.host" id="host" value="${config.getValue$1["mail.smtp.host"]}" /></span></td>
</tr>
<tr>
	<td class="row2" width="38%"><span class="gen"><jforum:i18n key="Config.Form.MailPort"/></span></td>
	<td class="row2" width="38%"><span class="gen"><input type="text" size="10" name="p_mail.smtp.port" id="port" value="${config.getValue$1["mail.smtp.port"]}" /></span></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row2" width="38%"><span class="gen"><input type="text" size="50" name="p_mail.smtp.username" id="username" value="${config.getValue$1["mail.smtp.username"]}" /></span></td>
</tr>
<tr>
	<td class="row1" width="38%"><span class="gen"><jforum:i18n key="Config.Form.SmtpPassword"/></span></td>
	<td class="row1" width="38%"><span class="gen"><input type="text" name="p_mail.smtp.password" id="password" value="${config.getValue$1["mail.smtp.password"]}" /></span></td>
</tr>
<tr>
